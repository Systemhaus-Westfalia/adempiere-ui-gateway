...
**Approach:**
- Use `env_template.env` as template with documentation
- Define derived variables (e.g., `POSTGRES_CONTAINER_NAME=${COMPOSE_PROJECT_NAME}.postgresql`)
- start-all.sh copies to `.env` automatically
